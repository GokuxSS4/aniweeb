            ...
            <div key={anime.rank} className="relative w-full">
              <div className="relative w-full h-[450px] lg:h-[600px] brightness-50">
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(to right, rgba(0,0,0,0.8) 0%, rgba(0,0,0,0.6) 30%, rgba(0,0,0,0.4) 60%, rgba(0,0,0,0.2) 80%, rgba(0,0,0,0) 100%), linear-gradient(to bottom, rgba(0,0,0,0) 40%, rgba(0,0,0,1) 100%)",
                  }}
                />
              </div>
